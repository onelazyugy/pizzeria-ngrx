export const environment = {
  production: true,
  registerUrl: 'https://pizzera.herokuapp.com/pizzeria/api/v1/user/register',
  loginUrl: 'https://pizzera.herokuapp.com/pizzeria/api/v1/user/login',
  addWingToCartUrl: 'https://pizzera.herokuapp.com/pizzeria/api/v1/cart/add',
